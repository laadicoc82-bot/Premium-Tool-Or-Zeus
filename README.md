...
STEIN=render('COLLAB',colors=stein_colors,align='center',font='block',background='black')
QE=render('𝗔𝗬𝗨𝗦𝗛 𝗫  𝗞𝗥𝗜𝗦𝗛  𝗫 𝗦𝗘𝗡𝗣𝗔𝗜 𝗫 𝗦𝗢𝗙𝗜𝗬𝗔𝗡 𝗫 𝗚𝗢𝗞𝗨 𝗫 𝗛𝗔𝗭𝗠𝗔 𝗫 𝗞𝗔𝗭𝗠𝗔 𝗫 𝗪𝗘𝗫 𝗫 𝗣𝗥𝗜𝗡𝗖𝗘 𝗫 𝗗𝗔𝗥𝗞𝗘𝗡 𝗫 𝗗𝗜𝗘𝗗 𝗫 𝗧𝗘𝗔𝗠 𝗗𝗔𝗥𝗞 𝗫 𝗦𝗡𝗢𝗪 𝗫 𝗔𝗬𝗔𝗡 𝗫 𝗦𝗫𝗞𝗦𝗛𝗫𝗠 𝗫 𝗕𝗛𝗔𝗩𝗜𝗦𝗛𝗬𝗔 𝗫 𝗥𝗢𝗛𝗔𝗡 𝗫 𝗨𝗝𝗝𝗪𝗔𝗟  𝗫 𝗚𝗛𝗢𝗦𝗧 𝗫 𝗥𝗘𝗫𝗫𝗬 𝗫 𝗦𝗛𝗔𝗜𝗧𝗔𝗡',colors=qe_colors,align='right',font='console',background='black')
print(STEIN)
...
Token=input(f"{x}𝗧𝗢𝗞𝗘𝗡 : ")

if __name__ == "__main__":
    user_id = input(f"{x}𝗜𝗗 : ").strip()
    print("wait a moment...");
...
def pppp():os.system('cls'if os.name=='nt'else'clear');terminal_width=os.get_terminal_size().columns;print(f"   {x}𝗛𝗜𝗧: [{hits}]{white}   {x}𝗘** 𝗞𝗘 𝗜𝗧𝗡𝗘 𝗕𝗔𝗔𝗣: [{bad_gm}]{white}  {x}𝗕𝗔𝗗: [{bad_mail}]    ")
...
for k in range(1,10):print(f"{x} - {2010+k}")
